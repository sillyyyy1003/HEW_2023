...
BoxCollider::BoxCollider(DirectX::XMFLOAT3 center, DirectX::XMFLOAT3 extentsDirectX::XMFLOAT3 center, DirectX::XMFLOAT3 extents)
{
...
void BoxCollider::UpdatePos(DirectX::XMFLOAT3 m_centerDirectX::XMFLOAT3 m_center)
{
    m_boxCollider.Center = m_center;
}


void BoxCollider::Update(DirectX::XMFLOAT3 m_center, DirectX::XMFLOAT3 m_rotationDirectX::XMFLOAT3 m_center, DirectX::XMFLOAT3 m_rotation)
{
    if (!isActive) 
    { 
        return;
